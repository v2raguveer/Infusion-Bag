library(Seurat)
library(cowplot)
ctrl.data <- Read10X(data.dir = "C:/Users/raguveerv2/Documents/Data/Infusion Bag/cellrangerFiltered/s284_filterMatrix")
acti.data <- Read10X(data.dir = "C:/Users/raguveerv2/Documents/Data/Infusion Bag/cellrangerFiltered/s285_filterMatrix")
